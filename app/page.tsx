...
export default function Home() {
  ...
  return <main className="app-shell">
    <header className="nav-bar"><div className="brand">舍</div>{area && <button className="quiet" onClick={() => setStage("settlement")}><PackageOpen size={18}/><span>本次整理</span><i>{items.length}</i></button>}</header>
